...
@section('block')
    <form id="invoice_add" method="POST" action="{{ route('invoice.save') }}" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="number" name="customer_no" class="form-control" oninput="maxLengthCheck(this)" id="customer_no"
        ...
        <div class="row">
            <div class="col-md-12">
                <p id="subtotal" class="text-sm-end"></p>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <p id="gstamount" class="text-sm-end"></p>
            </div>
        </div>
        <input type="hidden" id="total_amount" name="total_amount">
        <input type="hidden" id="gst_total_amount" name="gst_total_amount">
        <input type="hidden" id="sub_total_amount" name="sub_total_amount">


        <div class="row">
            <div class="col-md-12">

                <p id="total" class="text-sm-end"></p>
            </div>
        </div>
